...
const STEPS = [
  { key: 'preparing', label: 'Locking your selection', detail: 'Paper, subjects, chapters, and timer stay exactly as chosen.' },
  { key: 'requesting', label: 'Assembling questions', detail: 'Eduraa is creating or recovering your practice attempt.' },
  { key: 'opening', label: 'Opening the exam player', detail: 'Your practice begins when the paper opens.' },
] as const
  ...
  return (
    ...
    >
      ...
      <View accessibilityLiveRegion="polite" style={styles.copy}>
        ...
        <Text style={styles.body}>
          {failed
            ...
            : 'Eduraa is turning your exact PYQ selection into a focused practice attempt.'}
        </Text>
      </View>
      ...
      {failed ? (
        ...
        <Text style={styles.footnote}>Keep Eduraa open while your practice set is prepared.</Text>
      )}
    </AppScreen>
  )
}
